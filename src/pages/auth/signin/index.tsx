  ...
  return (
    <main className="relative grid h-full min-h-screen place-content-center p-4">
      ...
      <div className="flex-1">
        <Card className="mx-auto w-full max-w-lg p-10">
          ...
          <p className="mt-8 text-center font-normal text-black">Bem vindo(a)!</p>
          ...
          <CardContent className="p-0">
            ...
            <div className="text-center">
              <h2 className="mt-6 text-xl font-bold tracking-tight text-gray-900 sm:text-2xl md:text-3xl">
                Faça login em sua conta
              </h2>
              <p className="mt-2 text-sm text-gray-600">Acesse o portal unificado</p>
            </div>

            {/* Seção de teste de usuários */}

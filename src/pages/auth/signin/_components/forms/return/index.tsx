...
export const ReturnForm = () => {
  ...
  return (
    <div className="flex-1">
      <Card
        className={cn('lg:w-lg mx-auto w-full max-w-lg p-6 md:p-8 lg:p-10', isSmallScreen && 'py-2 md:py-6 lg:py-6')}
      >
        <div className={cn('my-8 sm:my-10 md:my-12 lg:my-[54px]', isSmallScreen && 'my-4 sm:my-4 md:my-4 lg:my-2')}>
          <div
            className={cn(
